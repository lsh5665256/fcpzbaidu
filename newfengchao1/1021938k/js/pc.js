...
if (ispcorphone === 'phone') {
    window.location.href = 'http://map.baidu.com/zt/qudao/newfengchao1/1019801e/html/home.html';
} else{
    ...
    function  statistics(eventType) {
        ...
        function setInfo(city) {
            $.ajax({
                type: 'GET',
                async: false,
                url: 'http://integralwall.baidu.com/integralwall/interact/landingrecoder?partner=fengchao&event_type=' + eventType + '&os=' + xitong + '&browser=' + liulanqi + '&model=' + phoneInfo + '&loc_city=' + city + '&flag_view=' +  flagView+ '&flag_download=' + flagDownload,
                dataType: 'jsonp',
                jsonpCallback: 'callback',
                success: (res) => {
                    // console.log(190);
