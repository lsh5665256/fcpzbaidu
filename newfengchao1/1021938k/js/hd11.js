...
function start() {
    ...
    // 获取所有的按钮
        ...
        if (isAndroid) {
                ...
                flag_download = '';
                tokenUrl = window.location.href+ '&clickTime=' + nowTime + '&random=' + wayView + '&dukouling=' + dukouling  + '&partner=' + partner +'&os=Android&ch=1021938k';
                xitong = 2;
        } else {
            ...
            // 所有个性落地页白色字(除了地铁)
            $('.baisebao .yinsitop1 .bao1 .update1').css('background-image','url(../img/baiyinsi/iosbanben2bai.png)');
            // 地铁落地页ios版本
            // $(".span").css('cssText','color:#fff !important;')
            $('.subwaybox .update1').css('cssText','background-image:url(../img/yinsi/iosshijian.png) !important;');
            xitong = 1;
            tokenUrl = 'http://map.baidu.com/zt/qudao/newfengchao1/1021938i/html/home.html' +location.search + '&clickTime=' + nowTime + '&random=' + wayView + '&dukouling=' + dukouling + '&partner=' + partner + '&os=iphone&ch=1021938l';
        }
        ...
        //     // TODO: 手动上报返回数据处理 },
        //     alert(1)
        //        console.log(responseData,1111111111111)
        //     },
        //     subid: 'login'
        // });
            if (clickNum === 0) {
            ...
            function setInfo(city) {
                $.ajax({
                    ...
                    url: 'http://integralwall.baidu.com/integralwall/interact/landingrecoder?partner=fengchao&event_type=' + eventType
                        + '&os=' + xitong
                        + '&browser=' + liulanqi
                        + '&model=' + phoneInfo + '&loc_city=' + city + '&plan_id=' + objData.planId + '&unit_id=' + objData.unitId + '&idea_id=' + objData.ideaId + '&word_id=' + objData.wordId + '&flag_download=' + flag_download + '&flag_view=' +  flagView + '&user_id=' + objData.userId + '&seckey=' +seckey,
                    dataType: 'jsonp',
                    jsonpCallback: 'callback',
                    success: (res) => {
                        // console.log(res);
        ...
        // // 浮窗消失
        // var xiaoshishijian = 1620662400000;
        // console.log(nowTime)
        // if (xiaoshishijian <nowTime) {
